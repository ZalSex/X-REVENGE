    ...
    try {
      ...
      if (mounted) {
        if (action == 'approve') {
          ...
          showError(context, 'Top up ditolak');
        }
      }
    } catch (_) {}
  }
...
class _CartSheetState extends State<_CartSheet> {
  static const int _vipPriceBasic = 30000;
  ...
  void _startBuy() {
    if (_balance < _vipPrice) {
      showError(context, 'Saldo tidak cukup! Top up dulu ya.');
      return;
    }
          ...
          StatefulBuilder(builder: (ctx2, setStateBtn) => GestureDetector(
            onTap: _buying ? null : () async {
              ...
              if (user.isEmpty || pass.length < 6) {
                showError(context, 'Username & password wajib diisi (min 6 karakter)');
                return;
              }
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [const Color(0xFF1E88E5), Color(0xFFFFA000)]),
                borderRadius: BorderRadius.circular(8)),
              child: _buying
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 8),
              const Text('KERANJANG VIP', style: TextStyle(fontFamily: 'Orbitron', fontSize: 14,
                  fontWeight: FontWeight.bold, color: Colors.white, letterSpacing: 1.5)),
              const Spacer(),
              GestureDetector(
  ...
  Widget _tabBtn(int idx, String label, IconData icon) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(10),
          gradient: active ? const LinearGradient(colors: [const Color(0xFF1E88E5), Color(0xFFFFA000)]) : null,
          color: active ? null : AppTheme.cardBg,
          border: Border.all(color: active ? Colors.transparent : AppTheme.textMuted.withOpacity(0.2))),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(colors: [
            active ? const Color(0xFF1E88E5).withOpacity(0.12) : Colors.transparent,
            Colors.transparent,
          ]),
        ),
        child: Row(children: [
  ...
  Widget _buildBuyTab(ScrollController ctrl) {
    return ListView(controller: ctrl, padding: const EdgeInsets.fromLTRB(20, 4, 20, 32), children: [
      ...
      Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(14),
          gradient: LinearGradient(colors: [const Color(0xFF1565C0).withOpacity(0.3), AppTheme.cardBg]),
          border: Border.all(color: const Color(0xFF1565C0).withOpacity(0.5))),
        child: Row(children: [
          Container(width: 44, height: 44,
            decoration: BoxDecoration(color: const Color(0xFF1565C0).withOpacity(0.2),
                borderRadius: BorderRadius.circular(12), border: Border.all(color: const Color(0xFF1565C0).withOpacity(0.4))),
            child: const Center(child: Icon(Icons.account_balance_wallet_rounded, color: Color(0xFF1565C0), size: 22))),
      ...
      Container(
        ...
        child: Column(children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [const Color(0xFF1E88E5).withOpacity(0.15), Colors.transparent]),
              borderRadius: const BorderRadius.vertical(top: Radius.circular(15)),
              border: const Border(bottom: BorderSide(color: const Color(0x331E88E5)))),
            child: Row(children: [
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(12),
                  gradient: const LinearGradient(colors: [const Color(0xFF1E88E5), Color(0xFFFFA000)]),
                  boxShadow: [BoxShadow(color: const Color(0xFF1E88E5).withOpacity(0.3), blurRadius: 12)]),
