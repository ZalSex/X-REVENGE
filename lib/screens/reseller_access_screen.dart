  ...
  Future<void> _createVip() async {
    ...
    try {
      ...
      if (res['success'] == true) {
        ...
        _showCenterNotif(
          message: res['message'] as String? ?? 'Gagal Membuat Akun VIP',
          success: false,
        );
      }
    } catch (e) {
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  'Sebagai Reseller Kamu Bisa Buat Akun VIP Untuk User',
...
class _CenterNotifDialog extends StatelessWidget {
  ...
  void _copyText(BuildContext context, String text) {
    ...
    showInfo(context, 'Disalin ke clipboard');
  }

  @override
  Widget build(BuildContext context) {
    final color = success ? const Color(0xFF00E5FF) : Colors.red;
    return Dialog(
      ...
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          // Data box (only on success with username/password)
          if (success && username != null && password != null) ...[
            ...
            Container(
              ...
              child: Column(children: [
                _DataRow(label: 'Username', value: username!, color: color, onCopy: () => _copyText(context, username!)),
                const SizedBox(height: 8),
                _DataRow(label: 'Password', value: password!, color: color, onCopy: () => _copyText(context, password!)),
                const Divider(color: Colors.white12, height: 20),
                // Copy all
                GestureDetector(
                  onTap: () => _copyText(context, 'Username: $username\nPassword: $password'),
                  child: Container(
                    width: double.infinity,
